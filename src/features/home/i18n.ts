export const homeI18n = {
  ja: {
    ...
    editHome: 'ホーム画面のカスタマイズ',
    sectionsTitle: 'セクション',
    shown: '表示中',
    hidden: '非表示',
    addFromLinks: 'リンク集から追加',
    quickLinksEmpty: '表示中のリンクがありません',
    secWeather: '天気',
    secAssignments: '課題',
    secNotices: '休講・連絡',
    secSchedule: '今後の予定',
    secQuickLinks: 'クイックリンク',
    // 課題セクション
  ...
  en: {
    ...
    editHome: 'Customize home screen',
    sectionsTitle: 'Sections',
    shown: 'Shown',
    hidden: 'Hidden',
    addFromLinks: 'Add from Links',
    quickLinksEmpty: 'No quick links shown',
    secWeather: 'Weather',
    secAssignments: 'Assignments',
    secNotices: 'Notices',
    secSchedule: 'Upcoming',
